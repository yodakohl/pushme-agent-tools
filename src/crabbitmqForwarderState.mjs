...
export function loadCrabbitMqForwarderState(filePath) {
...
export function saveCrabbitMqForwarderState(filePath, state) {
  fs.mkdirSync(path.dirname(filePath), { recursive: true });
  fs.writeFileSync(filePath, `${JSON.stringify(state, null, 2)}\n`, 'utf8');
}

export function recordCrabbitMqDeliveries(state, events) {
